...
final class Version20221010195358 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'All entity to MySql Bdd';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, price NUMERIC(15, 2) NOT NULL, total_weight INT DEFAULT NULL, duration NUMERIC(15, 2) NOT NULL, picture VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, develop VARCHAR(50) NOT NULL, status VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', update_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_232B318C67B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, posts_id INT DEFAULT NULL, games_posts_id INT DEFAULT NULL, title VARCHAR(50) NOT NULL, text LONGTEXT NOT NULL, picture VARCHAR(255) NOT NULL, status VARCHAR(255) DEFAULT NULL, grades INT DEFAULT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_5A8A6C8DD5E258C5 (posts_id), INDEX IDX_5A8A6C8D7CE53FF9 (games_posts_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, user_role VARCHAR(255) DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', username VARCHAR(60) NOT NULL, email VARCHAR(50) NOT NULL, password VARCHAR(255) NOT NULL, lastname VARCHAR(50) NOT NULL, firstname VARCHAR(50) NOT NULL, is_enable TINYINT(1) NOT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', picture VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
